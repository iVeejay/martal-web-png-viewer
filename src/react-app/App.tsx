// PNG Sequence Viewer — a local, browser-only animation preview tool for
// game artists. All state lives here and flows down to the viewer, control
// panel and timeline. No files are ever uploaded.
